...
// FIXED: Hapus efek parallax pada hero section yang menyebabkan nabrak
window.addEventListener('scroll', () => {
    const scrolled = window.pageYOffset;
    
    // Hanya update particles, TIDAK hero section
...
function showSurprise() {
    ...
    // Tampilkan container surprise
    surpriseContainer.innerHTML = `
        <div class="surprise-pop">
            <img src="images/surprise.jpg" alt="Special Surprise" class="surprise-image">
            <div class="surprise-message">
                I hope you still remember this photo...
            </div>
        </div>
    `;
    ...
    // Scroll ke surprise section
    surpriseContainer.scrollIntoView({ 
        behavior: 'smooth',
        block: 'center'
    });
}